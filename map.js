$(function() {
  ...
  areaArr.push(
    /*지역구 이름*/         /*위도*/               /*경도*/            
    {location : '본찌돈까스' , lat : '37.2971523' , lng : '126.9715006', description: '일본식 전통 돈까스을 맛보고싶다면!', imageTag: 'img/food.png', type: 'Food'},  // 강남구 중심좌표
    {location : '벨라튀니지' , lat : '37.2972199' , lng : '126.9713739', description: '율전에서 이색적인 음식을 먹고싶다면!', imageTag: 'img/food.png', type: 'Food'},  // 강동구 중심좌표
    {location : '알촌' , lat : '37.297476' , lng : '126.9717054', description: '성대 혼밥 맛집 알촌!', imageTag: 'img/food.png', type: 'Food'},  // 강북구 중심좌표
    {location : '무대포핫도그' , lat : '37.2969972' , lng : '126.9712576', description: '성균관대 근처 중독성 있는 핫도그 맛집!', imageTag: 'img/food.png', type: 'Food'},  // 강서구 중심좌표
    {location : '힌카쿠' , lat : '37.2979467' , lng : '126.9721954', description: '차슈가 맛있는 일본 음식점!', imageTag: 'img/food.png', type: 'Food'},
    {location : '깡우동' , lat : '37.2984079' , lng : '126.9704937', description: '우동맛집 분위기맛집 깡우동!', imageTag: 'img/food.png', type: 'Food'},
    {location : '독산성 족발&순대국' , lat : '37.2982302' , lng : '126.9712576', description: '쫄깃한 콜라겐 족발!', imageTag: 'img/food.png', type: 'Food'},
    {location : '충만치킨' , lat : '37.2985579' , lng : '126.9696108', description: '매콤하고 맛있는 고추장 티꾸닭!', imageTag: 'img/food.png', type: 'Food'},
    {location : '자명문' , lat : '37.2992317' , lng : '126.9699131', description: '빈티지 스타일의 이색 스터디/놀공 카페!', imageTag: 'img/cafe.png', type: 'Cafe'},
    {location : '먹깨비김밥' , lat : '37.2986624' , lng : '126.971376', description: '늦은 밤 떡볶이가 생각난다...', imageTag: 'img/food.png', type: 'Food'},
    {location : '국제식당' , lat : '37.2979487' , lng : '126.9732216', description: '저렴하고 푸짐한 한식 맛집!', imageTag: 'img/food.png', type: 'Food'},
    {location : '성대목장' , lat : '37.2969672' , lng :'126.9692569', description: '고기 질도 좋고 값도 싼 진짜 정육식당 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '성대찌개고을' , lat : '37.2971789' , lng :'126.96936', description: '시원 칼칼한 국물 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '명가양꼬치' , lat : '37.2967229' , lng :'126.9691429', description: '양꼬치, 양갈비살, 온면 다 맛있는 진짜 찐 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '카페더쉐어' , lat : '37.2971137' , lng :'126.9682585', description: '한적하고 대화하기 좋은 곳!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '카페로브' , lat : '37.296911' , lng :'126.968156', description: '대화하기 편하고 책보기 좋은 디저트 카페!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '사거리다방' , lat : '37.2971214' , lng :'126.9682363', description: '분위기 아늑하고 케이크랑 티가 너무 맛있는 카페!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '섬세한남자' , lat : '37.2977115' , lng :'126.9685395', description: '재즈가 흘러나오는 데이트하기 좋은 카페!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '태영생막창' , lat : '37.297833' , lng :'126.9685266', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : '칼국수여행' , lat : '37.2977383' , lng :'126.9688166', description: '칼국수도 맛나고 열무김치가 맛있는 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '포동이네' , lat : '37.2979313' , lng :'126.9689787', description: '초밥 맛집 혼밥 가능한 포동이네!', imageTag: 'img/food.png',type:'Food'},
    {location : '경기수산' , lat : '37.2980763' , lng :'126.968677', description: '저렴하고 장어 맛있는 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '바다참치' , lat : '37.2985145' , lng :'126.9712435', description: '참치 회전식 데이트장소!', imageTag: 'img/food.png',type:'Food'},
    {location : '독도참치' , lat : '37.2991013' , lng :'126.9711644', description: '수원 율전동 참치 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '짬뽕타임' , lat : '37.2985426' , lng :'126.9693008', description: '가성비 좋은 중국집 짬뽕타임 !', imageTag: 'img/food.png',type:'Food'},
    {location : '르디망슈' , lat : '37.2988341' , lng :'126.968734', description: '성균관대역 감성카페!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '정성가득찬' , lat : '37.2979929' , lng :'126.9678454', description: '정성가득찬 제주 우도특산 반찬전문!', imageTag: 'img/food.png',type:'Food'},
    {location : '또봉이통닭' , lat : '37.2984338' , lng :'126.9676702', description: '옛날통닭 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '회좋아' , lat : '37.2982738' , lng :'126.9676137', description: '푸짐하고 저렴한 회맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '롤랑까페' , lat : '37.2977069' , lng :'126.9673613', description: '케이크가 맛있는 카페롤랑!', imageTag: 'img/food.png',type:'Food'},
    {location : '미스꼬꼬' , lat : '37.2988094' , lng :'126.967656', description: '율전동 퓨전포차 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '미쳐라' , lat : '37.2989657' , lng :'126.9677024', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : '모수밀면' , lat : '37.2988341' , lng :'126.968734', description: '내호냉면과 모수밀면 율전 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '채움거진코다리네' , lat : '37.2988185' , lng :'126.9694155', description: '건강한 생선요리 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '어반그레이' , lat : '37.2989143' , lng :'126.9693341', description: '율전동 루프탑 맥주집!', imageTag: 'img/cafe.png',type:'Beverages'},
    {location : '오디디' , lat : '37.2987629' , lng :'126.9698674', description: '연말인데 감성 채우러 OD가지?', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '피자스쿨' , lat : '37.2987629' , lng :'126.9698674', description: '저렴하고 맛도 좋은 한국식피자!', imageTag: 'img/food.png',type:'Food'},
    {location : '인더비엣' , lat : '37.2988669' , lng :'126.9705375', description: '배트남음식점에서 지인과 점심먹기!', imageTag: 'img/food.png',type:'Food'},
    {location : '대동집' , lat : '37.2989289' , lng :'126.9700998', description: '안주가 맛있는 대동집!', imageTag: 'img/beer.png',type:'Beverages'},
    {location : '김씨화로' , lat : '37.2994117' , lng :'126.9701733', description: '맛있고 저렴한.. 학생들의 성지같은 술집!', imageTag: 'img/beer.png',type:'Beverages'},
    {location : '옥집' , lat : '37.2986458' , lng :'126.9707803', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : '황금족발' , lat : '37.2983174' , lng :'126.9710333', description: '입에서 녹는 족발 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '명륜진사갈비' , lat : '37.298892' , lng :'126.971302', description: '저렴한 가격에 맛있는 돼지갈비!', imageTag: 'img/food.png',type:'Food'},
    {location : '북한산조개구이' , lat : '37.2990396' , lng :'126.9712832', description: '조개구이 무한리필 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '스타벅스' , lat : '37.2988351' , lng :'126.9715664', description: '근본!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '이라부' , lat : '37.2990353' , lng :'126.9717586', description: '분위기 좋은 2차 술집!', imageTag: 'img/beer.png',type:'Beverages'},
    {location : '요거베리' , lat : '37.2996087' , lng :'126.9717982', description: '분위기 좋은 베리 카페!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '엉터리생고기' , lat : '37.2993022' , lng :'126.9711594', description: '삼겹살 소고기 무한리필 우삼겹 된장찌개 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '오르카커피룸' , lat : '37.2996845' , lng :'126.9706692', description: '분위기 좋은 율전동 카페!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '택이네조개전골' , lat : '37.2991652' , lng :'126.9701895', description: '조개로 배채울 수 있다!', imageTag: 'img/food.png',type:'Food'},
    {location : '수코미치' , lat : '37.2991485' , lng :'126.9706186', description: '수코미치 간식어울림점!', imageTag: 'img/food.png',type:'Food'},
    {location : '사우스스트릿' , lat : '37.2981546' , lng :'126.9689075', description: '성대역 필라델피아 수제버거 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '썬더치킨' , lat : '37.298132' , lng :'126.9690739', description: '가성비 좋은 옛날 치킨 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '오스트리아우노' , lat : '37.2981548' , lng :'126.9692553', description: '샐러드에 리코타치즈를 아낌없이 올려주는 파스타 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '가장맛있는족발' , lat : '37.2980261' , lng :'126.9692339', description: '회식장소는 가장맛있는 족발에서!', imageTag: 'img/food.png',type:'Food'},
    {location : '자장수전주콩나물국밥' , lat : '37.2983027' , lng :'126.9693116', description: '율전에서 가성비 좋은 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : '슈가블랑' , lat : '37.294569' , lng :'126.9677094', description: '케이크가 너무 맛있는 슈가블랑!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '디아카페' , lat : '37.2944595' , lng :'126.9679365', description: '한가하고 쾌적한 카페!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '율전동미미' , lat : '37.2962057' , lng :'126.9682937', description: '미미가 초밥으로 기분 좋은 점식식사!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '예감쪽갈비' , lat : '37.2965356' , lng :'126.9687496', description: '주기적으로 가줘야되는 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '생각나는순대국' , lat : '37.296755' , lng :'126.9682785', description: '남자순대국으로 유명한 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '빨간석쇠구이' , lat : '37.2969535' , lng :'126.9684989', description: '옛날통닭이 맛있는 율전동 2차 술집!', imageTag: 'img/beer.png',type:'Beverages'},
    {location : '카와마루아지' , lat : '37.2969036' , lng :'126.968736', description: '율전동에서 제일 준수한 라멘/차슈동 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '반갑다친구야' , lat : '37.2968932' , lng :'126.9690425', description: '솥뚜껑 생삼겹살 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '안서동야곱집' , lat : '37.2970303' , lng :'126.9690541', description: '성대역 술집 야채 곱창 막창!', imageTag: 'img/beer.png',type:'Beverages'},
    {location : '선참치' , lat : '37.2970303' , lng :'126.9690541', description: '참치무한리필 선참치 못참지!', imageTag: 'img/food.png',type:'Food'},
    {location : '홍추곱창카페' , lat : '37.2972039' , lng :'126.9686988', description: '냄새도 안나고 양도 많은 곱창집!', imageTag: 'img/food.png',type:'Food'},
    {location : 'intensecoffee' , lat : '37.2972745' , lng :'126.9688977', description: '커피가 맛있는 집!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '뎅과꼬치로' , lat : '37.2972348' , lng :'126.9691551', description: '분위기도 맛도 좋은 오뎅바!', imageTag: 'img/food.png',type:'Food'},
    {location : 'Manda' , lat : '37.2970833' , lng :'126.9695785', description: '가정식 맛집 만다!', imageTag: 'img/food.png',type:'Food'},
    {location : '항아리보쌈' , lat : '37.2970011' , lng :'126.9698686', description: '부드러운 수육과 맛난 막국수로 든든한 한끼!', imageTag: 'img/food.png',type:'Food'},
    {location : '차돌풍' , lat : '37.297088' , lng :'126.9698846', description: '차돌풍 커플셋트 율전동 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '정든닭발' , lat : '37.2970518' , lng :'126.9701761', description: '닭발은 정든 닭발!', imageTag: 'img/food.png',type:'Food'},
    {location : '미가라멘' , lat : '37.2971985' , lng :'126.9701616', description: '간단하고 든든한 라멘 한끼!', imageTag: 'img/food.png',type:'Food'},
    {location : '영희네고기' , lat : '37.2972913' , lng :'126.9702631', description: '율전동 찌개 고기 한식 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '목구멍' , lat : '37.2976242' , lng :'126.9701391', description: '곹뚜껑으로 구워 더 맛있는 삼겹살 맛집!', imageTag: 'img/food.png',type:'Food'},
    {location : '육회독존' , lat : '37.297693' , lng :'126.9701437', description: '신림 터줏대감 느낌의 가게!', imageTag: 'img/food.png',type:'Food'},
    {location : '마포구이촌' , lat : '37.2975555' , lng :'126.9703847', description: '학생들 저럼한 값에 먹기에는 이만한 집 없음!', imageTag: 'img/food.png',type:'Food'},
    {location : '블랙스미스' , lat : '37.2976624' , lng :'126.970452', description: '분위기 좋고 맛도 좋은 술집!', imageTag: 'img/beer.png',type:'Beverages'},
    {location : '한창희천하일면' , lat : '37.2977394' , lng :'126.9702223', description: '제주도 갈 필요없는 천하일면!', imageTag: 'img/food.png',type:'Food'},
    {location : '백령도생바지락칼국수' , lat : '37.2975303' , lng :'126.9703644', description: '백령도에서 넘어온 국물이 시원한 칼국수!', imageTag: 'img/food.png',type:'Food'},
    {location : '1인자감자탕뼈해장국' , lat : '37.2977889' , lng :'126.9704898', description: '감자탕과 볶음밥이 맛있는 맛집!', imageTag: 'img/food.png',type:'Food'},
    ...
    {location : '양평해장국' , lat : '37.2904645' , lng:'126.9761564', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : '참숮풍천장어' , lat : '37.2902994' , lng:'126.9765187', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : '카페 나노' , lat : '37.2910788' , lng:'126.9778939', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '카나호프' , lat : '37.2901005' , lng:'126.9781429', description: '율전에서 즐겁게 놀고 싶다면!', imageTag: 'img/beer.png',type:'Beverages'},
    {location : '우락이네딹찝' , lat : '37.2903757' , lng:'126.9785120', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : '작은별카페' , lat : '37.2900268' , lng:'126.9778991', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '수수한가' , lat : '37.2897729' , lng:'126.9778196', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : '해담' , lat : '37.2898566' , lng:'126.9779805', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : '돈치킨' , lat : '37.2898812' , lng:'126.9782722', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : '본앤김밥' , lat : '37.2895606' , lng:'126.9785336', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : 'Tous Les Jours Cafe' , lat : '37.2894640' , lng:'126.9786129', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : 'BHC치킨' , lat : '37.2889892' , lng:'126.9788526', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : '찜닭에 꽂힌 닭집애' , lat : '37.2890151' , lng:'126.9783413', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : '소치COFFEE' , lat : '37.2889356' , lng:'126.9780959', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '부현숯불갈비' , lat : '37.2887462' , lng:'126.9775293', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : '이가네 삼대째 손두부' , lat : '37.2890233' , lng:'126.9774146', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : '수원숭이' , lat : '37.2895037' , lng:'126.9774206', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '본래순대' , lat : '37.290007' , lng:'126.978260', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : '원조명동 찌개마을' , lat : '37.289965' , lng:'126.978218', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : '엉클kun커피하우스' , lat : '37.290388' , lng:'126.978495', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/cafe.png',type:'Cafe'},
    {location : '회뜨는수산' , lat : '37.290273' , lng:'126.978466', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    {location : '카츠요이' , lat : '37.290511' , lng:'126.978526', description: '율전에서 이색적인 음식을 먹고 싶다면!', imageTag: 'img/food.png',type:'Food'},
    ...
    for (var i = 0; i < areaArr.length; i++) {
        ...
        /* 정보창 */
         var infoWindow = new naver.maps.InfoWindow({
             content: `<div class="infoTab" style="width:200px;text-align:center;padding:10px;border-radius:5px;"><b><center><div class="imageplace" style="background-image: url(${areaArr[i].imageTag}); background-size: contain; background-repeat: no-repeat; background-position:center;"></div></center>`
